...
class TestRAGEngineFallbackWarningLog:
    ...
    async def test_fallback_warning_with_none_thresholds(self, engine, caplog):
        """Test that fallback warning log handles None thresholds without TypeError."""
        ...
        with caplog.at_level(logging.WARNING):
            ...
            sources = await engine._filter_relevant(results)
    ...
    async def test_fallback_warning_with_zero_threshold(self, engine, caplog):
    ...
    async def test_fallback_warning_with_valid_threshold(self, engine, caplog):
    ...
    async def test_fallback_warning_logs_correctly_with_none(self, engine, caplog):
    ...
    async def test_safe_threshold_calculation_with_both_none(self, engine):
    ...
    async def test_safe_threshold_uses_relevance_when_max_is_none(self, engine):
...
class TestRAGEngineThresholdEdgeCases:
    ...
    async def test_empty_results_with_none_threshold(self, engine):
    ...
    async def test_single_result_with_none_threshold(self, engine):
    ...
    async def test_results_without_distance_field_and_none_threshold(self, engine):
